...
public class Main {
    public static void main(String[] args) {
        ...
        authors.stream()
                .flatMap(author -> author.getBooks().stream())
                .distinct()
                .flatMap(catetory -> Arrays.stream(catetory.getCategory().split(",")))
                .filter(catetory -> !catetory.equals("哲学") && !catetory.equals("爱情"))
                .distinct()
                .forEach(ca -> System.out.println(ca));
        System.out.println();
        ...
        Set<String> set = authors.stream()
                .map(author -> author.getIntro())
                .collect(Collectors.toSet());
        System.out.println(set);

        val map = authors.stream()
                .distinct()
